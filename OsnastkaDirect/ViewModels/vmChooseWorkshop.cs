...
{
    /// <summary>
    /// Класс ChooseWorkshop (ViewModel)
    /// </summary>
    class vmChooseWorkshop : VMBase
    {
        #region Переменные
            ...
            /// Переменная View
            /// </summary>
            public ChooseWorkshop View;
            /// <summary>
            /// Переменная Model
            /// </summary>
            public mChooseWorkshop Model;
        //
        ...
        public vmChooseWorkshop()
            ...
            {
                View = (ChooseWorkshop)view;
                Model = (mChooseWorkshop)model;
                //
